...
export const subproyectoCreateSchema = z.object({
    ...
    autAplicacionAguaId: z.number().positive(),
    autAplicacionSueloId: z.number().positive(),
    autAplicacionGasesId: z.number().positive(),
    autAplicacionFLNAId: z.number().positive()
});
